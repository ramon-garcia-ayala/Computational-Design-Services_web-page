...
- \`layout\` — one floor plate subdivided into rooms by area: space planning, unit layouts, program distribution, circulation. The subject is a single level and the rooms in it.
