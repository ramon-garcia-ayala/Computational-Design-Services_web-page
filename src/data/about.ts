/**
 * `/about`: the founding story, the facts, and the people. Nothing else — no
 * mission or values section, by decision.
 */
export const about = {
  kicker: "About us",
  ...
  /* Stated outright rather than hidden behind a hover, unlike Home's version:
     someone on this page came to read, not to explore. */
  facts: "Founded 2026 · First project in the US · Work spanning Lebanon, Mexico, and the US",
